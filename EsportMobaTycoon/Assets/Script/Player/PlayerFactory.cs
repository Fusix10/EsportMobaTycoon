...
public class PlayerFactory : MonoBehaviour
{
    ...
    public Player CreateRandomPlayerWithRole(GameManager.Role role, int potential = 0, Sprite icon = null, bool Data = false)
    {
        GameObject playerObj = Instantiate(PlayerPrefabs);
        ...
        playerObj.GetComponent<Player>().Init(name, knickname, favoriteRole, mechanic, knowledge, favoriteCharacterId, teamSpirit, reputation, potential, GameManager.Instance.i_allMood[UnityEngine.Random.Range(0, 9)], currentRole, null, icon);
        return playerObj.GetComponent<Player>();
    }
