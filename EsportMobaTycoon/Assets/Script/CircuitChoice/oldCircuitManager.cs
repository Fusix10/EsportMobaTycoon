...
public class oldCircuitManager : MonoBehaviour
{
    ...
    private Dictionary<int, (oldCircuit, CircuitTracks)> i_circuitsChoices;
    private oldCircuit i_selectedCircuit;
    private CircuitState i_selectedCircuitState;

    void Start()
    {
        i_circuitsChoices = new Dictionary<int, (oldCircuit, CircuitTracks)>();
    ...
    public void GenerateCircuit(int amount)
    {
        ...
        {
            oldCircuit newCircuit = new oldCircuit(i);
            ...
            for (int j = 0; j < tournamentCount; j++)
            {
                ...
                oldTournament tournament = new oldTournament(AllTournament, false, "Tournament " + j);
                oldCircuitAction c = new oldCircuitAction();
                ...
                {
                    oldMatch newMatch = new oldMatch();
            ...
            {
                oldTournament majorTournament = new oldTournament(AllTournament, true, "Major Tournament");
    ...
    void GenerateCircuitUI()
    {
        ...
        foreach (var circuit in i_circuitsChoices)
        {
            ...
            string tournamentDetails = new string("w");
